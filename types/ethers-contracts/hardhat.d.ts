...
getContractFactory(name: 'FaceRecord', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.FaceRecord__factory>

  getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>
getContractAt(name: 'FaceRecord', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.FaceRecord>

  deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'FaceRecord', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.FaceRecord>

  deployContract(name: 'Counter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'FaceRecord', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.FaceRecord>
